...
def lu_decomposition(mat): # decomposes the input matrix into a LU form
    length = len(mat[0])
    lower = I.copy()
    upper = mat.copy()
...
def main():
    ...
    solution30 = solve_lu_decomposition(lower30, upper30, vector_30)
    q27_lu_decomposition = solution27[0]
    q30_lu_decomposition = solution30[0]
    print(q27_lu_decomposition)
    print(q30_lu_decomposition)
    return q30_lu_decomposition, q27_lu_decomposition